...
//        while(dvizi!=null){
//            if(dvizi.element.getLoyalty()<min){
//                min=dvizi.element.getLoyalty();
//                najmal=dvizi;
//            }
//            dvizi=dvizi.succ;
//        }
//        golden.delete(najmal);
//        normal.insertLast(najmal.element);
//        dvizi= normal.getFirst();
//        SLLNode<Client> najgolem= null;
//        int max=0;
//        while (dvizi!=null){
//            if(dvizi.element.getLoyalty()>max){
//                max=dvizi.element.getLoyalty();
//                najgolem=dvizi;
//            }
//            dvizi=dvizi.succ;
//        }
//        normal.delete(najgolem);
//        golden.insertLast(najgolem.element);
