...
//     SLLNode<Discussion> najmal=null;
//     int min=101;
//     while (dvizi!=null){
//         if(dvizi.element.getPopularity()<=min){
//             min=dvizi.element.getPopularity();
//             najmal=dvizi;
//         }
//         dvizi=dvizi.succ;
//     }
//
//     finance.delete(najmal);
//     dvizi= health.getFirst();
//     SLLNode<Discussion> najvazen= null;
//     int max=-1;
//     while (dvizi!=null){
//         if(dvizi.element.getPopularity()>max){
//             max=dvizi.element.getPopularity();
//             najvazen=dvizi;
//         }
//         dvizi=dvizi.succ;
//     }
//     finance.insertLast(najvazen.element);
//    }
//
//
