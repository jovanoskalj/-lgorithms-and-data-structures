...
//public class Race {
//
//   public static void competition(SLL<Athlete> prev , SLL<Athlete> segasna){
//    SLLNode<Athlete> dvizi=prev.getFirst();
//    SLLNode<Athlete> najbaven=null;
//    double max=0;
//    while(dvizi!=null){
...
//
//    }
//    dvizi=segasna.getFirst();
//    while(dvizi!=null){
//        if(dvizi.element.getTime()>najbaven.element.getTime()){
//            segasna.delete(dvizi);
//        }
//        dvizi=dvizi.succ;
//    }
//   }
